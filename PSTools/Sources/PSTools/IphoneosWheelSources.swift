...
extension IphoneosWheelSources {
    ...
    public func all_wheels(sdk: ProjectSpec.Platform) -> [String] {
        var wheels = [String]()
    ...
    public func all_wheels(sdk: ProjectSpec.Platform) async throws -> [any WheelSource] {
    ...
    public func all_wheels(sdk: ProjectSpec.Platform) async throws -> [PackageData] {
        
        let packages: [PackageData] = try await all_wheels(sdk: .iOS).asyncMap({try await $0.packageData()})
